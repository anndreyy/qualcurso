...
export default {
  ...
  methods:{
    return_sort: function (){
      this.curso = this.cursos[Math.floor(Math.random() * this.cursos.length)];
    },
    open_search: function(sort){      
      const url = "https://www.google.com/search?q=" + sort;
